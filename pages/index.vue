                                ...
                                <ul class="show-notification row">
                                    ...
                                    <li class="col-sm-3">
                                        ...
                                        <div class="row m-b-20">
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-2.jpg" alt="Gallery-1">
                                            </div>
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-3.jpg" alt="Gallery-2">
                                            </div>
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-4.jpg" alt="Gallery-3">
                                            </div>
                                        </div>
                                        <div class="row m-b-20">
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-3.jpg" alt="Gallery-4">
                                            </div>
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-4.jpg" alt="Gallery-5">
                                            </div>
                                            <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="assets/images/avatar-2.jpg" alt="Gallery-6">
                                            </div>
                                        </div>
                ...
                <div class="had-container">
                    <div class="card card_main p-fixed users-main">
                        <div class="user-box">
                            ...
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 545px;"><div class="main-friend-list" style="overflow: hidden; width: auto; height: 545px;">
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar" navbar-theme="themelight1" active-item-theme="theme4" sub-item-theme="theme2" active-item-style="style0" pcoded-navbar-position="fixed">
                        ...
                        <div class="pcoded-inner-navbar main-menu mCustomScrollbar _mCS_1" id="" style="height: calc(100% - 80px);"><div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical_horizontal mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container_wrapper" class="mCSB_container_wrapper mCS_x_hidden mCS_no_scrollbar_x"><div id="mCSB_1_container" class="mCSB_container" style="position: relative; top: -10px; left: 0px; width: 100%;" dir="ltr">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.navigation" menu-title-theme="theme1">Navigation</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu active pcoded-trigger" dropdown-icon="style1" subitem-icon="style6">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.ui-element" menu-title-theme="theme1">UI Element</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms" menu-title-theme="theme1">Forms</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.tables" menu-title-theme="theme1">Tables</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.chart-and-maps" menu-title-theme="theme1">Chart And Maps</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.pages" menu-title-theme="theme1">Pages</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.app" menu-title-theme="theme1">App</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class=" ">
                                    <a href="chat.html">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.extension" menu-title-theme="theme1">Extension</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.other" menu-title-theme="theme1">Other</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="pcoded-hasmenu" dropdown-icon="style1" subitem-icon="style6">
                                    <a href="javascript:void(0)">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.support" menu-title-theme="theme1">Support</div>
                            <ul class="pcoded-item pcoded-left-item" item-border="true" item-border-style="none" subitem-border="true">
                                <li class="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-xl-8">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div id="statestics-chart" style="height: 330px; overflow: hidden; text-align: left;"><div class="amcharts-main-div" style="position: relative;"><div class="amcharts-chart-div" style="overflow: hidden; position: relative; text-align: left; width: 201px; height: 330px; padding: 0px; cursor: default;"><svg version="1.1" style="position: absolute; width: 201px; height: 330px; top: -0.203125px; left: -0.203125px;"><desc>JavaScript chart by amCharts 3.21.5</desc><g><path cs="100,100" d="M0.5,0.5 L200.5,0.5 L200.5,329.5 L0.5,329.5 Z" fill="#FFFFFF" stroke="#000000" fill-opacity="0" stroke-width="1" stroke-opacity="0"></path><path cs="100,100" d="M0.5,0.5 L166.5,0.5 L166.5,294.5 L0.5,294.5 L0.5,0.5 Z" fill="#FFFFFF" stroke="#000000" fill-opacity="0" stroke-width="1" stroke-opacity="0" transform="translate(34,0)"></path></g><g><g transform="translate(34,0)"></g><g transform="translate(34,0)" visibility="visible"><g><path cs="100,100" d="M0.5,294.5 L0.5,294.5 L166.5,294.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,245.5 L0.5,245.5 L166.5,245.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,196.5 L0.5,196.5 L166.5,196.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,147.5 L0.5,147.5 L166.5,147.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,98.5 L0.5,98.5 L166.5,98.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,49.5 L0.5,49.5 L166.5,49.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,0.5 L0.5,0.5 L166.5,0.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.1" stroke="#000000"></path></g></g></g><g transform="translate(34,0)" clip-path="url(#AmChartsEl-52)"><g visibility="hidden"><g transform="translate(0,0)" visibility="hidden"><rect x="0.5" y="0.5" width="18" height="294" rx="0" ry="0" stroke-width="0" fill="#FC6180" stroke="#FC6180" fill-opacity="0" stroke-opacity="0" transform="translate(-10,0)"></rect></g></g></g><g></g><g></g><g></g><g><g transform="translate(34,0)"><g clip-path="url(#AmChartsEl-55)"><path cs="100,100" d="M9,246 C14,244,19,202,28,202 C37,202,37,246,46,246 C55,247,56,212,65,214 C74,215,74,277,83,274 C92,271,92,164,101,152 C110,140,111,34,120,39 C129,44,129,251,138,256 C147,261,152,148,157,142 M0,0 L0,0" fill="none" fill-opacity="0" stroke-width="2" stroke-opacity="1" stroke="#4680ff"></path></g><g clip-path="url(#AmChartsEl-54)"><path cs="100,100" d="M9,246 C14,244,19,202,28,202 C37,202,37,246,46,246 C55,247,56,212,65,214 C74,215,74,277,83,274 C92,271,92,164,101,152 C110,140,111,34,120,39 C129,44,129,251,138,256 C147,261,152,148,157,142 M0,0 L0,0" fill="none" fill-opacity="0" stroke-width="2" stroke-opacity="1" stroke="#4680ff"></path></g><clipPath id="AmChartsEl-54"><rect x="0" y="0" width="166" height="294" rx="0" ry="0" stroke-width="0"></rect></clipPath><clipPath id="AmChartsEl-55"><rect x="0" y="294" width="166" height="1" rx="0" ry="0" stroke-width="0"></rect></clipPath><g></g></g></g><g></g><g><path cs="100,100" d="M0.5,294.5 L166.5,294.5 L166.5,294.5" fill="none" stroke-width="1" stroke-dasharray="6" stroke-opacity="0.2" stroke="#000000" transform="translate(34,0)"></path><g><path cs="100,100" d="M0.5,0.5 L166.5,0.5" fill="none" stroke-width="1" stroke-opacity="0" stroke="#000000" transform="translate(34,294)"></path></g><g><path cs="100,100" d="M0.5,0.5 L0.5,294.5" fill="none" stroke-width="1" stroke-opacity="0" stroke="#000000" transform="translate(34,0)" visibility="visible"></path></g></g><g><g transform="translate(34,0)" clip-path="url(#AmChartsEl-53)" style="pointer-events: none;"><path cs="100,100" d="M0.5,0.5 L166.5,0.5 L166.5,0.5" fill="none" stroke-width="1" stroke-opacity="false" stroke="#FC6180" visibility="hidden"></path></g><clipPath id="AmChartsEl-53"><rect x="0" y="0" width="166" height="294" rx="0" ry="0" stroke-width="0"></rect></clipPath></g><g></g><g><g transform="translate(34,0)"><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(9,246)" aria-label=" Jan 0.98"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(28,202)" aria-label=" Feb 1.87"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(46,246)" aria-label=" Mar 0.97"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(65,214)" aria-label=" Apr 1.64"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(83,274)" aria-label=" May 0.4"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(101,152)" aria-label=" Jun 2.9"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(120,39)" aria-label=" Jul 5.2"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(138,256)" aria-label=" Aug 0.77"></circle><circle r="4.5" cx="0" cy="0" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(157,142)" aria-label=" Sap 3.1"></circle></g></g><g><g></g></g><g><g transform="translate(34,0)" visibility="visible"><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="middle" transform="translate(9,311.5)"><tspan y="6" x="0">Jan</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="middle" transform="translate(83,311.5)"><tspan y="6" x="0">May</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="middle" transform="translate(157,311.5)"><tspan y="6" x="0">Sap</tspan></text></g><g transform="translate(34,0)" visibility="visible"><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,293)"><tspan y="6" x="0">0</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,244)"><tspan y="6" x="0">1</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,195)"><tspan y="6" x="0">2</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,146)"><tspan y="6" x="0">3</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,97)"><tspan y="6" x="0">4</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,48)"><tspan y="6" x="0">5</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,-1)"><tspan y="6" x="0">6</tspan></text></g></g><g></g><g transform="translate(34,0)"></g><g></g><g></g><clipPath id="AmChartsEl-52"><rect x="-1" y="-1" width="168" height="296" rx="0" ry="0" stroke-width="0"></rect></clipPath></svg></div></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xl-4">

                                                <div class="card card-blue total-card"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                    <div class="card-block">
                                                        <div class="text-left">
                                                            <h4>4000</h4>
                                                    ...
                                                    <canvas id="total-value-graph-1" class="total-value-graph" height="31" width="241" style="display: block; width: 241px; height: 31px;"></canvas>
                                                </div>

                                                <div class="card card-pink total-card"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                    <div class="card-block">
                                                        <div class="text-left">
                                                            <h4>489</h4>
                                                    ...
                                                    <canvas id="total-value-graph-2" class="total-value-graph" height="31" width="241" style="display: block; width: 241px; height: 31px;"></canvas>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card email-sent-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div id="email-sent" style="max-width: 100%; height: 400px; overflow: hidden; text-align: left;"><div class="amcharts-main-div" style="position: relative; width: 100%; height: 100%;"><div class="amChartsLegend amcharts-legend-div" style="overflow: hidden; position: relative; text-align: left; width: 201px; height: 132px;"><svg version="1.1" style="position: absolute; width: 201px; height: 132px; top: -0.203125px; left: -0.203125px;"><desc>JavaScript chart by amCharts 3.21.5</desc><g transform="translate(64,10)"><path cs="100,100" d="M0.5,0.5 L116.5,0.5 L116.5,121.5 L0.5,121.5 Z" fill="#FFFFFF" stroke="#000000" fill-opacity="0" stroke-width="1" stroke-opacity="0"></path><g transform="translate(0,11)"><g cursor="pointer" aria-label="Actual Sales" transform="translate(0,0)"><path cs="100,100" d="M-15.5,8.5 L16.5,8.5 L16.5,-7.5 L-15.5,-7.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1" transform="translate(16,8)"></path><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(37,7)"><tspan y="6" x="0">Actual Sales</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(161,7)"> </text><rect x="32" y="0" width="129.234375" height="18" rx="0" ry="0" stroke-width="0" stroke="none" fill="#fff" fill-opacity="0.005"></rect></g><g cursor="pointer" aria-label="Target Sales" transform="translate(0,28)"><path cs="100,100" d="M-15.5,8.5 L16.5,8.5 L16.5,-7.5 L-15.5,-7.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1" transform="translate(16,8)"></path><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(37,7)"><tspan y="6" x="0">Target Sales</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(161,7)"> </text><rect x="32" y="0" width="129.234375" height="18" rx="0" ry="0" stroke-width="0" stroke="none" fill="#fff" fill-opacity="0.005"></rect></g><g cursor="pointer" aria-label="Market Days" transform="translate(0,56)"><g><path cs="100,100" d="M0.5,8.5 L32.5,8.5" fill="none" stroke-width="3" stroke-dasharray="10" stroke-opacity="1" stroke="#93BE52"></path><circle r="0.001" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(17,8)"></circle></g><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(37,7)"><tspan y="6" x="0">Market Days</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(161,7)"> </text><rect x="32" y="0" width="129.234375" height="18" rx="0" ry="0" stroke-width="0" stroke="none" fill="#fff" fill-opacity="0.005"></rect></g><g cursor="pointer" aria-label="Actual Sales" transform="translate(0,84)"><path cs="100,100" d="M-15.5,8.5 L16.5,8.5 L16.5,-7.5 L-15.5,-7.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1" transform="translate(16,8)"></path><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(37,7)"><tspan y="6" x="0">Actual Sales</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(161,7)"> </text><rect x="32" y="0" width="129.234375" height="18" rx="0" ry="0" stroke-width="0" stroke="none" fill="#fff" fill-opacity="0.005"></rect></g></g></g></svg></div><div class="amcharts-chart-div" style="overflow: hidden; position: relative; text-align: left; width: 201px; height: 268px; padding: 0px;"><svg version="1.1" style="position: absolute; width: 201px; height: 268px; top: -0.203125px; left: -0.203125px;"><desc>JavaScript chart by amCharts 3.21.5</desc><g><path cs="100,100" d="M0.5,0.5 L200.5,0.5 L200.5,267.5 L0.5,267.5 Z" fill="#FFFFFF" stroke="#000000" fill-opacity="0" stroke-width="1" stroke-opacity="0"></path><path cs="100,100" d="M0.5,0.5 L116.5,0.5 L116.5,217.5 L0.5,217.5 L0.5,0.5 Z" fill="#FFFFFF" stroke="#000000" fill-opacity="0" stroke-width="1" stroke-opacity="0" transform="translate(64,20)"></path></g><g><g transform="translate(64,20)"><g><path cs="100,100" d="M0.5,217.5 L0.5,217.5 L0.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M17.5,217.5 L17.5,217.5 L17.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g><g><path cs="100,100" d="M33.5,217.5 L33.5,217.5 L33.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g><g><path cs="100,100" d="M50.5,217.5 L50.5,217.5 L50.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g><g><path cs="100,100" d="M66.5,217.5 L66.5,217.5 L66.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g><g><path cs="100,100" d="M83.5,217.5 L83.5,217.5 L83.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M99.5,217.5 L99.5,217.5 L99.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g><g><path cs="100,100" d="M116.5,217.5 L116.5,217.5 L116.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.07" stroke="#000000"></path></g></g><g transform="translate(64,20)" visibility="visible"><g><path cs="100,100" d="M0.5,217.5 L6.5,217.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,217.5 L0.5,217.5 L116.5,217.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,174.5 L6.5,174.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,174.5 L0.5,174.5 L116.5,174.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,130.5 L6.5,130.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,130.5 L0.5,130.5 L116.5,130.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,87.5 L6.5,87.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,87.5 L0.5,87.5 L116.5,87.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,43.5 L6.5,43.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,43.5 L0.5,43.5 L116.5,43.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g><g><path cs="100,100" d="M0.5,0.5 L6.5,0.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path><path cs="100,100" d="M0.5,0.5 L0.5,0.5 L116.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.15" stroke="#000000"></path></g></g><g transform="translate(64,20)" visibility="visible"><g><path cs="100,100" d="M0.5,217.5 L6.5,217.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g><g><path cs="100,100" d="M0.5,174.5 L6.5,174.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g><g><path cs="100,100" d="M0.5,130.5 L6.5,130.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g><g><path cs="100,100" d="M0.5,87.5 L6.5,87.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g><g><path cs="100,100" d="M0.5,43.5 L6.5,43.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g><g><path cs="100,100" d="M0.5,0.5 L6.5,0.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(-6,0)"></path></g></g></g><g transform="translate(64,20)" clip-path="url(#AmChartsEl-47)"><g visibility="hidden"></g></g><g></g><g></g><g></g><g><g transform="translate(64,20)"><g><g transform="translate(5,217)" aria-label="Actual Sales Jan 16, 2013 8.00"><path cs="100,100" d="M0.5,0.5 L0.5,-173.5 L1.5,-173.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(22,217)" aria-label="Actual Sales Jan 17, 2013 6.00"><path cs="100,100" d="M0.5,0.5 L0.5,-129.5 L1.5,-129.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(38,217)" aria-label="Actual Sales Jan 18, 2013 2.00"><path cs="100,100" d="M0.5,0.5 L0.5,-42.5 L1.5,-42.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(55,217)" aria-label="Actual Sales Jan 19, 2013 9.00"><path cs="100,100" d="M0.5,0.5 L0.5,-194.5 L1.5,-194.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(72,217)" aria-label="Actual Sales Jan 20, 2013 6.00"><path cs="100,100" d="M0.5,0.5 L0.5,-129.5 L1.5,-129.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(88,217)" aria-label="Actual Sales Jan 21, 2013 5.00"><path cs="100,100" d="M0.5,0.5 L0.5,-107.5 L1.5,-107.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(105,217)" aria-label="Actual Sales Jan 22, 2013 7.00"><path cs="100,100" d="M0.5,0.5 L0.5,-151.5 L1.5,-151.5 L1.5,0.5 L0.5,0.5 Z" fill="#4680ff" stroke="#4680ff" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g></g></g><g transform="translate(64,20)"><g><g transform="translate(7,217)" aria-label="Target Sales Jan 16, 2013 5.00"><path cs="100,100" d="M0.5,0.5 L0.5,-107.5 L1.5,-107.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(24,217)" aria-label="Target Sales Jan 17, 2013 4.00"><path cs="100,100" d="M0.5,0.5 L0.5,-86.5 L1.5,-86.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(40,217)" aria-label="Target Sales Jan 18, 2013 5.00"><path cs="100,100" d="M0.5,0.5 L0.5,-107.5 L1.5,-107.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(57,217)" aria-label="Target Sales Jan 19, 2013 8.00"><path cs="100,100" d="M0.5,0.5 L0.5,-173.5 L1.5,-173.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(74,217)" aria-label="Target Sales Jan 20, 2013 9.00"><path cs="100,100" d="M0.5,0.5 L0.5,-194.5 L1.5,-194.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(90,217)" aria-label="Target Sales Jan 21, 2013 3.00"><path cs="100,100" d="M0.5,0.5 L0.5,-64.5 L1.5,-64.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(107,217)" aria-label="Target Sales Jan 22, 2013 5.00"><path cs="100,100" d="M0.5,0.5 L0.5,-107.5 L1.5,-107.5 L1.5,0.5 L0.5,0.5 Z" fill="#FC6180" stroke="#FC6180" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g></g></g><g transform="translate(64,20)"><g></g><g clip-path="url(#AmChartsEl-49)"><path cs="100,100" d="M8,35 C12,42,17,177,25,182 C33,188,33,152,41,148 C49,143,50,89,58,87 C67,85,67,112,75,113 C83,114,83,102,91,104 C99,106,104,145,108,148 M0,0 L0,0" fill="none" fill-opacity="0" stroke-width="3" stroke-dasharray="10" stroke-opacity="1" stroke="#93BE52"></path></g><clipPath id="AmChartsEl-49"><rect x="0" y="0" width="116" height="217" rx="0" ry="0" stroke-width="0"></rect></clipPath><g></g></g><g transform="translate(64,20)"><g><g transform="translate(10,217)" aria-label="Actual Sales Jan 16, 2013 8.00"><path cs="100,100" d="M0.5,0.5 L0.5,-173.5 L1.5,-173.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(27,217)" aria-label="Actual Sales Jan 17, 2013 6.00"><path cs="100,100" d="M0.5,0.5 L0.5,-129.5 L1.5,-129.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(43,217)" aria-label="Actual Sales Jan 18, 2013 2.00"><path cs="100,100" d="M0.5,0.5 L0.5,-42.5 L1.5,-42.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(60,217)" aria-label="Actual Sales Jan 19, 2013 9.00"><path cs="100,100" d="M0.5,0.5 L0.5,-194.5 L1.5,-194.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(77,217)" aria-label="Actual Sales Jan 20, 2013 6.00"><path cs="100,100" d="M0.5,0.5 L0.5,-129.5 L1.5,-129.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(93,217)" aria-label="Actual Sales Jan 21, 2013 5.00"><path cs="100,100" d="M0.5,0.5 L0.5,-107.5 L1.5,-107.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g><g transform="translate(110,217)" aria-label="Actual Sales Jan 22, 2013 7.00"><path cs="100,100" d="M0.5,0.5 L0.5,-151.5 L1.5,-151.5 L1.5,0.5 L0.5,0.5 Z" fill="#FFB64D" stroke="#FFB64D" fill-opacity="1" stroke-width="1" stroke-opacity="1"></path></g></g></g></g><g></g><g><path cs="100,100" d="M0.5,217.5 L116.5,217.5 L116.5,217.5" fill="none" stroke-width="1" stroke-opacity="0.3" stroke="#000000" transform="translate(64,20)"></path><g><path cs="100,100" d="M0.5,0.5 L116.5,0.5" fill="none" stroke-width="1" stroke-opacity="0" stroke="#000000" transform="translate(64,237)"></path></g><g><path cs="100,100" d="M0.5,0.5 L0.5,217.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(64,20)" visibility="visible"></path></g><g><path cs="100,100" d="M0.5,0.5 L0.5,217.5" fill="none" stroke-width="1" stroke-opacity="1" stroke="#000000" transform="translate(64,20)" visibility="visible"></path></g></g><g><g transform="translate(64,20)" clip-path="url(#AmChartsEl-48)" style="pointer-events: none;"><path cs="100,100" d="M0.5,0.5 L0.5,0.5 L0.5,217.5" fill="none" stroke-width="1" stroke-opacity="0" stroke="#CC0000" visibility="hidden"></path><path cs="100,100" d="M0.5,0.5 L116.5,0.5 L116.5,0.5" fill="none" stroke-width="1" stroke-opacity="0.2" stroke="#CC0000" visibility="hidden"></path></g><clipPath id="AmChartsEl-48"><rect x="0" y="0" width="116" height="217" rx="0" ry="0" stroke-width="0"></rect></clipPath></g><g></g><g><g transform="translate(64,20)"></g><g transform="translate(64,20)"></g><g transform="translate(64,20)"><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(8,35)" aria-label="Market Days Jan 16, 2013 91.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(25,182)" aria-label="Market Days Jan 17, 2013 74.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(41,148)" aria-label="Market Days Jan 18, 2013 78.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(58,87)" aria-label="Market Days Jan 19, 2013 85.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(75,113)" aria-label="Market Days Jan 20, 2013 82.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(91,104)" aria-label="Market Days Jan 21, 2013 83.00"></circle><circle r="2" cx="0" cy="0" fill="transparent" stroke="#93BE52" fill-opacity="1" stroke-width="2" stroke-opacity="0" transform="translate(108,148)" aria-label="Market Days Jan 22, 2013 78.00"></circle></g><g transform="translate(64,20)"></g></g><g><g></g></g><g><g transform="translate(64,20)" visibility="visible"><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(3,229.5)"><tspan y="6" x="0">Jan 16</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="start" transform="translate(86,229.5)"><tspan y="6" x="0">Jan 21</tspan></text></g><g transform="translate(64,20)" visibility="visible"><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,216)"><tspan y="6" x="0">0</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,173)"><tspan y="6" x="0">2</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,129)"><tspan y="6" x="0">4</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,86)"><tspan y="6" x="0">6</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,42)"><tspan y="6" x="0">8</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="11px" opacity="1" text-anchor="end" transform="translate(-12,-1)"><tspan y="6" x="0">10</tspan></text><text y="6" fill="#000000" font-family="Verdana" font-size="12px" opacity="1" font-weight="bold" text-anchor="middle" transform="translate(-43,109) rotate(-90)"><tspan y="6" x="0">Sales</tspan></text></g><g transform="translate(64,20)" visibility="visible"><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,217)"><tspan y="0" x="0">70</tspan></text><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,174)"><tspan y="0" x="0">75</tspan></text><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,130)"><tspan y="0" x="0">80</tspan></text><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,87)"><tspan y="0" x="0">85</tspan></text><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,43)"><tspan y="0" x="0">90</tspan></text><text y="0" fill="#000000" font-family="Verdana" font-size="0px" opacity="1" text-anchor="end" transform="translate(-12,0)"><tspan y="0" x="0">95</tspan></text></g></g><g></g><g transform="translate(64,20)"></g><g></g><g></g><clipPath id="AmChartsEl-47"><rect x="-1" y="-1" width="118" height="219" rx="0" ry="0" stroke-width="0"></rect></clipPath></svg></div></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Email Sent End -->
                                                    ...
                                                    <div class="card-block ">
                                                        <div class="card-contain text-center ">
                                                            ...
                                                            <div class="contain-card p-t-30 p-b-10 ">
                                                                <a href="#!"><img src="assets/images/avatar-4.jpg" data-toggle="tooltip" title="" alt="" class="img-40" data-original-title="Alia"></a>
                                                                <a href="#!"><img src="assets/images/avatar-3.jpg" data-toggle="tooltip" title="" alt="" class="img-40 m-l-5" data-original-title="Suzen"></a>
                                                                <a href="#!"><img src="assets/images/avatar-4.jpg" data-toggle="tooltip" title="" alt="" class="img-40 m-l-5" data-original-title="Lary Doe"></a>
                                                                <a href="#!"><img src="assets/images/avatar-2.jpg" data-toggle="tooltip" title="" alt="" class="img-40 m-l-5" data-original-title="Josephin Doe"></a>
                                                            </div>
                                                        </div>
                                                    </div>
...
export default {
    ...
    // { rel: 'stylesheet', href: 'assets/myAssets/assets/scss/style.scss',' },
    { rel: 'stylesheet', href: '/myAssets/bower_components/bootstrap/css/bootstrap.min.css' },
      { rel: 'stylesheet', href: '/myAssets/assets/icon/themify-icons/themify-icons.css' },
      { rel: 'stylesheet', href: '/myAssets/assets/icon/icofont/css/icofont.css' },
      { rel: 'stylesheet', href: '/myAssets/assets/pages/flag-icon/flag-icon.min.css' },
      { rel: 'stylesheet', href: '/myAssets/assets/pages/menu-search/css/component.css' },
      { rel: 'stylesheet', href: '/myAssets/assets/pages/dashboard/horizontal-timeline/css/style.css' },
      { rel: 'stylesheet', href: '/myAssets/bower_components/chartist/css/chartist.css'},
      { rel: 'stylesheet', href: '/myAssets/bower_components/c3/css/c3.css'},
      { rel: 'stylesheet', href: '/myAssets/assets/css/style.css'},
      { rel: 'stylesheet', href: '/myAssets/assets/css/jquery.mCustomScrollbar.css'},
        ],
